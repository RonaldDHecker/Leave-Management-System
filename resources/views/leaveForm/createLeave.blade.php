    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <form class="needs-validation" action="{{ route('leaveForm.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                            <div class="col-md-3">
                                <div class="mb-3">
                    ...
                    <div class="row">
                        ...
                        <div class="row mb-3">
                            <div class="col-sm">
                                <label for="date2" class="col-sm-6 col-form-label">Start date</label>
                                <input class="form-control" type="date" value="" id="date2" name="date2">
                            </div>

                            <div class="col-sm">
                                <label for="date3" class="col-sm-6 col-form-label">Finish Date</label>
                    ...
                    <label for="leave">TYPE OF LEAVE TO BE AVAILED OF</label>
                        ...
                        <div class="col" id="leave" >
                            ...
                            <div style="margin-bottom: 15px; display:none" id="sick" style="" >
                                <label>
                                    <input type="radio" name="sick_choice" id="in_hospital" value="In Hospital" required>
                                    In Hospital
                                </label><br>
                                <label>
                                    <input type="radio" name="sick_choice" id="out_patient" value="Out Patient" >
                                    Out Patient
                                </label><br>
                                <div style="margin-bottom: 15px;" class="col-sm-6">
                                    <input type="text" class="form-control" id="sick_input" placeholder="Specify Illness" name="sick_input" required>
                                </div>
                                <div class="row mb-6">
                                    <label>
                                        Attachment(s):
                                    </label>
                                    <div id="sick_leave" class="col-sm-6">
                                        <input type="file" class="form-control" id="sick_leave_attachment" placeholder="" name="sick_leave_attachment">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div style="margin-bottom: 15px; display:none" id="maternity">
                                <div class="row mb-6">
                                    <label>
                                        Attachment(s):
                                    </label>
                                    <div id="maternity_leave" class="col-sm-6">
                                        <input type="file" class="form-control" id="maternity_leave_attachment" placeholder="" name="maternity_leave_attachment">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div style="margin-bottom: 15px; display:none" id="paternity">
                                <div class="row mb-6">
                                    <label>
                                        Attachment(s):
                                    </label>
                                    <div id="paternity_leave" class="col-sm-6">
                                        <input type="file" class="form-control" id="paternity_leave_attachment" name="paternity_leave_attachment">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div style="margin-bottom: 15px; display:none" id="slb" style="" >
                                <div class="row mb-6">
                                    <div style="margin-bottom: 15px;" class="col-sm-6">
                                        <input type="text" class="form-control" id="slb_input" placeholder="Specify Illness" name="slb_input" required>
                                    </div>
                                    <label>
                                        Attachment(s):
                                    </label>
                            ...
                            <div style="margin-bottom: 15px; display:none" id="calamity" style="" >
                                <div class="row mb-6">
                                    <label>
                                        Attachment(s):
                                    </label>
                                    <div id="calamity_leave" class="col-sm-6">
                                        <input type="file" class="form-control" id="calamity_leave_attachment" placeholder="" name="calamity_leave_attachment" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div style="margin-bottom: 15px; display:none" id="adoption" style="" >
                                <div class="row mb-6">
                                    <label>
                                        Attachment(s):
                                    </label>
                                    <div id="adoption_leave" class="col-sm-6">
                                        <input type="file" class="form-control" id="adoption_leave_attachment" placeholder="" name="adoption_leave_attachment" required>
                                    </div>
                                </div>
                            </div>
...
<script>
    ...
    document.getElementById("date1").value = formattedDate; //date of filing
    document.getElementById("date2").value = formattedDate; //start date
    document.getElementById("date3").value = formattedDate; //finish date
    ...
    const HOLIDAYS = [
      ...
      sick.style.marginLeft="5%"
      calamity.style.marginLeft="5%"
      maternity.style.marginLeft="5%"
      paternity.style.marginLeft="5%"
        ...
        const sick_input = document.querySelector('#sick_input'); //ML textboxes
        const slb_input = document.querySelector('#slb_input'); //ML textboxes
        ...
        const calamity_leave_attachment = document.querySelector('#calamity_leave_attachment'); //
        const maternity_leave_attachment = document.querySelector('#maternity_leave_attachment'); //
        const paternity_leave_attachment = document.querySelector('#paternity_leave_attachment'); //
        local.disabled = true;
        ...
        calamity_leave_attachment.disabled = true;
        sick_leave_attachment.disabled = true;
        maternity_leave_attachment.disabled = true;
        let selectedLeaveType = "";

    leave_type.forEach((button) => {
    button.addEventListener("change", () => {
        if (button.value === "Vacation Leave") {
            selectedLeaveType = "Vacation Leave";
            ...
            calamity.style.display="none";
            maternity.style.display = "none";
            paternity.style.display="none";
            ...
            document.getElementById("in_hospital").disabled = true;       //sickL radio buttons
            document.getElementById("out_patient").disabled = true;          //sickL radio buttons
            sick_input.disabled = true; //textboxes
            slb_input.disabled = true; //textboxes
            ...
            calamity_leave_attachment.disabled = true;
            maternity_leave_attachment.disabled = true;
            paternity_leave_attachment.disabled = true;
            ...
            selectedLeaveType = "Mandatory/Forced Leave";
        ...
        } else if (button.value === "Sick Leave") {
            ...
            document.getElementById("masters").disabled = true;       //StudyL radio buttons
            document.getElementById("exam").disabled = true;          //StudyL radio buttons
            document.getElementById("in_hospital").disabled = false;       //sickL radio buttons
            document.getElementById("out_patient").disabled = false;       //sickL radio buttons
            sick_input.disabled = false; //textboxes
            slb_input.disabled = true; //textboxes
            sick_leave_attachment.disabled = false;
            calamity_leave_attachment.disabled = true;
            m_local.disabled = true; //textboxes
            m_abroad.disabled = true; //textboxes
            spl_local.disabled = true;
            ...
            // const timeDifference = (date1 - date3);
            // // Convert milliseconds to days (1 day = 1000ms * 60s * 60min * 24hr)
            // const daysDifference = Math.floor(timeDifference / (1000 * 60 * 60 * 24));
            // if (daysDifference === 1){
            //     sick.style.display="none";
            // }

        } else if (button.value === "Maternity Leave"){
            selectedLeaveType = "Maternity Leave";
            maternity.style.display = "block";
            special.style.display="none";
            vacation.style.display = "none";
            mandatory.style.display = "none";
            solo.style.display = "none";
            ...
            adoption_leave_attachment.disabled = true;
            calamity_leave_attachment.disabled = true;
            maternity_leave_attachment.disabled = false;
            paternity_leave_attachment.disabled = true;

        } else if (button.value === "Paternity Leave") {
            selectedLeaveType = "Paternity Leave";
            paternity.style.display="block";
            special.style.display="none";
            vacation.style.display = "none";
            mandatory.style.display = "none";
            solo.style.display = "none";
            ...
            sick_input.disabled = true; //textboxes
            slb_input.disabled = true; //textboxes
            paternity_leave_attachment.disabled = false;
            study_leave_attachment.disabled = true;
            vawc_leave_attachment.disabled = true;
            rehab_leave_attachment.disabled = true;
            adoption_leave_attachment.disabled = true;
            ...
            selectedLeaveType = "Special Privilege Leave";
            ...
            selectedLeaveType = "Solo Parent Leave";
            ...
            selectedLeaveType = "10-Day VAWC Leave";
            ...
            selectedLeaveType = "Rehabilitation Privilege";
            ...
            selectedLeaveType = "Special Leave Benefits for Women";
            ...
            paternity_leave_attachment.disabled = true;
            sick_input.disabled = true; //textboxes
            slb_input.disabled = false; //textboxes
            local.disabled = true; //textboxes
            abroad.disabled = true; //textboxes
            m_local.disabled = true; //textboxes
            m_abroad.disabled = true; //textboxes
        ...
        } else if (button.value==="Special Emergency (Calamity) Leave"){
            selectedLeaveType = "Special Emergency (Calamity) Leave";
            calamity.style.display="block";
            adoption.style.display="none";
            slb.style.display = "none";
            rehab.style.display = "none";
            vawc.style.display = "none";
            ...
            maternity.style.display = "none";
            paternity.style.display="none";
            calamity_leave_attachment.disabled = false;
            adoption_leave_attachment.disabled = true;
            vawc_leave_attachment.disabled = true;
            study_leave_attachment.disabled = true;
            solo_parent_attachment.disabled = true;
            ...
            selectedLeaveType = "Adoption Leave";
    ...
    function calculateWeekdaysAndHolidays() {
        ...
        if (selectedLeaveType == "Sick Leave"){
                if (weekdays >=3) {
                    ...
                    alert("Must be at least 3 working days to apply for a leave"); // fix this
                    return false;
                }
        }
        else
