    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <form class="needs-validation" action="{{ route('leaveForm.store') }}" method="POST">
                    @csrf
                    <div class="row">
                            <div class="col-md-3">
                                <div class="mb-3">
...
<script>
    ...
    function calculateWeekdaysAndHolidays() {
        ...
        else if (selectedLeaveType == "Mandatory/Forced Leave"){
                if (weekdays >=3) {

                } else {
                    event.preventDefault();
                    alert("Must be at least 3 working days to apply for a leave");
                    return false;
                }
        }
