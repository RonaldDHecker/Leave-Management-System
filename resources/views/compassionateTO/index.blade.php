                ...
                <div class="card-body">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;">{{ $compassionate->leave_days }}</td>
                            <td>@if ($compassionate->filialObligation){{ $compassionate->filialObligation->reason; }}
                                ...
                                @endif</td>
                            <td><a type="button" class="btn btn-info center form-control" href="{{ route('compassionateTO.form', $compassionate->id) }}" target="_blank">View</a>
                            </div></td>
                            <td>{{ strtoupper($compassionate->statusCompassionateTO->admin) }}</td>
                        </tr>
                        @endforeach
                        </tbody>
