                ...
                <div class="card-body">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                        ...
                        <tr>
                            ...
                            <td>{{ strtoupper($leave->statusLeave->admin) }}</td>
                            ...
                            <div class="modal" id="myModal-{{ $leave->id }}">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ route('admin-leave-request.leaveApp.update' ,$leave->id) }}" method="POST" enctype="multipart/form-data">
                                            @method('PATCH')
                                            @csrf
                                            <div class="modal-body">
                                                <div class="mb-3">
                                                    <div class="mb-4">
                                                        ...
                                                        <a type="button" class="btn btn-info center form-control" href="#" target="_blank">View</a>
                                                    </div>
                                                    <div class="mb-4">
                                                        @if ($leave->sickLeave)
